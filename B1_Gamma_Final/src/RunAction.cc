...
RunAction::RunAction()
{
  ...
  analysisManager->CreateNtuple("HdpeCount", "Interactions at HDPE");
  analysisManager->CreateNtupleDColumn("eventID");
  analysisManager->CreateNtupleIColumn("parentID");
  analysisManager->CreateNtupleIColumn("trackID");
  analysisManager->CreateNtupleIColumn("pdgID");
  analysisManager->CreateNtupleDColumn("HdpeKineticEnergy");


  analysisManager->FinishNtuple();

  analysisManager->CreateNtuple("LeadCount", "Interactions at Lead");
  analysisManager->CreateNtupleDColumn("eventID");
  analysisManager->CreateNtupleIColumn("parentID");
  analysisManager->CreateNtupleIColumn("trackID");
  analysisManager->CreateNtupleIColumn("pdgID");
  analysisManager->CreateNtupleDColumn("LeadKineticEnergy");

  analysisManager->FinishNtuple();

  analysisManager->CreateNtuple("CopperCount", "Interactions at Copper");
  analysisManager->CreateNtupleDColumn("eventID");
  analysisManager->CreateNtupleIColumn("parentID");
  analysisManager->CreateNtupleIColumn("trackID");
  analysisManager->CreateNtupleIColumn("pdgID");
  analysisManager->CreateNtupleDColumn("CopperKineticEnergy");

  analysisManager->FinishNtuple();

  analysisManager->CreateNtuple("PolyCount", "Interactions at Polyethylene");
  analysisManager->CreateNtupleDColumn("eventID");
  analysisManager->CreateNtupleIColumn("parentID");
  analysisManager->CreateNtupleIColumn("trackID");
  analysisManager->CreateNtupleIColumn("pdgID");
  analysisManager->CreateNtupleDColumn("PolyKineticEnergy");
